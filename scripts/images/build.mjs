 ...
 * only a loaded image also has a local image id to report.
 */
...
export function parseImageBuildArguments(args, builder) {
  ...
  if (values.repository.length === 0 || values.repository.includes("@")) {
    throw new TypeError(
      `${builder.label} repository must not be empty or contain a digest`,
    );
  }
