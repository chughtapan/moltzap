...
description: "Pushed to the task initiator + invited participants after the app accepts via the `app/task/create` wire callback and the task transitions from `waiting` to `active`."
---
