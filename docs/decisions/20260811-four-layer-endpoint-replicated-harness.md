...
| G1-DEC-708 | Resolved — five packages publish as one calendar version set; the NanoClaw adapter and evals stay private. | `20260901-six-packages-publish-as-one-version-set.md` — Decision Outcome; `docs/spec/layer-interfaces.md` — Publication and versions | `ARCH`, `WIRE` |
...
| 2026-09-02 | The `G1-DEC-708` trace row names five publishing packages with the NanoClaw adapter private, matching the corrected outcome of `20260901-six-packages-publish-as-one-version-set.md`. This record's own Decision Outcome is unchanged. |
