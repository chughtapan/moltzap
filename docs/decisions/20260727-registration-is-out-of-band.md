...
| Date | Change |
|---|---|
| 2026-08-14 | Clarified that the later daemon registration presentation still invokes Registry-owned bootstrap admission, and linked its provenance and current normative owners. The historical out-of-band outcome remains fully superseded. |
