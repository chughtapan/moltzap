...
| G1-DEC-708 | `v2/VERSION`, all six package manifests, and MoltZap compatibility are exactly `2026.827.1` for this contract revision. | `docs/spec/layer-interfaces.md` — Publication and versions | `ARCH`, `WIRE` |
| G1-DEC-709 | MCP revision and simulator definition, event, and RunLedger persisted-schema versions remain independent of `v2/VERSION`. | `docs/spec/layer-interfaces.md` — Publication and versions | `ARCH` |
...
| G1-DEC-814 | npm publishing, bundling, deployment, production cutover, and production-line retirement remain deferred on the V2 track. The separate production Harness application and removal of its legacy surfaces remain `main`-owned dependencies rather than V2 authority. | `docs/spec/layer-interfaces.md` — Publication and versions; Deliberate deferrals | `DEFER` |
...
| 2026-09-02 | Normative-owner locators repointed for three historical inventory rows whose headings no longer exist: G1-DEC-708 and G1-DEC-709 (`Version contract`) → `docs/spec/layer-interfaces.md` — Publication and versions; G1-DEC-814 (`first-implementation.md` — Gate 4) → `docs/spec/layer-interfaces.md` — Publication and versions; Deliberate deferrals. Row text and the historical status the Supersession section assigns are unchanged. |
