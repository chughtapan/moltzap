...
> governs new execution work. Existing evidence interpretation, grading,
> SQLite, and Phoenix contracts remain current. Host-run outcome and resume
> examples below change to durable `executionId` start-or-attach receipts.
