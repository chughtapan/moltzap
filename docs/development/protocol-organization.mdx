...
import { LeaseRegistry } from "#message/dispatch";
...
import { LeaseRegistry } from "#message/dispatch/lease-registry";
...
1. Add `core/`, `socket/`, `http/`, `conversation/`, and `message/dispatch/`
   folders without moving behavior.
