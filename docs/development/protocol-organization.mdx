...
1. Split `identity/apps/host.ts` further into endpoint registry, dispatch
   admission, message authorization, and task-create callback services.
2. Continue narrowing server barrels as those services settle.
