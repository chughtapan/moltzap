...
- Node.js 22+ (the reproducible workspace release is pinned in `.node-version`)
- pnpm 10+
- PostgreSQL 15+ (or Docker)
- Docker (for PostgreSQL integration tests and protocol conformance tests with Toxiproxy)
