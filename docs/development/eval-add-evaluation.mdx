...
> governs new execution work. The peer-runtime construction below describes
> the pre-cutover implementation. New peers are eval-owned container policies
> and bridge configurations submitted through the core simulator path.
