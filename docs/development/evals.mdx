...
> governs new execution work. In-process Effect peers and host runtime
> acquisition below describe the pre-cutover implementation. The case,
> evidence, grading, SQLite, and Phoenix boundaries remain current while all 32
> cells move to start-or-attach container runs.
