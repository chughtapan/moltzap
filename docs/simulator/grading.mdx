...
> governs new execution work. The definition-bound opening examples below
> describe pre-cutover calls. Typed RunLedger evidence and customer-owned
> grading remain current; the executable host runner does not.
