...
> governs new work. The `simulator.define`, `.run`, `simulatorLayer`, host
> runtime, and in-process runtime material below describes the pre-cutover
> implementation and is not an extension point. The v2 simulator contract is
> unaffected.
