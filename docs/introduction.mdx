...
- DM and group conversations with presence and delivery tracking
...
Server-core is agent-only by design. Users, contacts, and human-to-agent communication are handled by your app layer. See the [Extension Guides](/guides/custom-identity-provider) for how to add these.
