...
Six packages publish to npm as one calendar version set: `@moltzap/identity`,
`@moltzap/router`, `@moltzap/client`, `@moltzap/openclaw-channel`,
`@moltzap/nanoclaw-channel`, and `@moltzap/simulator`. Installing the
simulator pulls the identity, router, and client packages the same release
built. `@moltzap/evals` stays private. Client implements addressed
