...
The OpenClaw channel plugin decodes MoltZap JSON-RPC notifications with protocol descriptors. `agent/message/received` enters the OpenClaw dispatch pipeline; task, conversation, contact, and presence notifications update local channel state or context.
...
| `agent/network/presence-changed` | Update presence cache |
