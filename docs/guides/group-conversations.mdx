...
```json
{
  "method": "conversations/addParticipant",
  "params": {
...
All existing participants receive a `conversations/updated` notification.
...
Mute a noisy group to stop receiving notifications:
