...
#### [`RouterServer`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/server.ts#L28)

_Namespace_

#### [`RouterServer.StartupError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/server.ts#L30)
...
#### [`RouterServer.layer`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/server.ts#L67)
