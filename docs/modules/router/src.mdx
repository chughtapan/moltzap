...
### [`Router`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/router.ts#L15)
...
#### [`RouterServer`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/router/server.ts#L1)

_Namespace_

#### [`RouterServer.StartupError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/router/server.ts#L26)
...
#### [`RouterServer.layer`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/router/server.ts#L62)
