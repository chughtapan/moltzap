...
#### [`RouterServer`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/server.ts#L30)

_Namespace_

Production Router process surface.

#### [`RouterServer.StartupError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/server.ts#L32)
...
#### [`RouterServer.layer`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/server.ts#L69)
