...
### [`Router`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/router.ts#L51)
...
#### [`RouterServer.layer`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/router/src/router/server.ts#L61)
