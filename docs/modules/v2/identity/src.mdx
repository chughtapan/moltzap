...
### [`AgentCard`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-card.ts#L104)
...
### [`AgentCard`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-card.ts#L399)
...
### [`AgentCardDigest`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L117)
...
### [`AgentCardDigest`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L111)
...
### [`AgentCardVerificationError`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-card.ts#L243)
...
### [`AgentId`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L81)
...
### [`AgentId`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L75)
...
### [`AgentName`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L131)
...
### [`AgentName`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L120)
...
### [`AgentSigningAuthority`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-signing-authority.ts#L11)
...
### [`AgentSigningAuthority`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-signing-authority.ts#L98)
...
### [`AgentSigningError`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/signing-errors.ts#L4)
...
### [`AuthenticatedHttp`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/authenticated-http.ts#L437)
...
### [`Ed25519PublicKey`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/ed25519-public-key.ts#L233)
...
### [`Ed25519PublicKey`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/ed25519-public-key.ts#L202)
...
### [`InvalidAgentPrivateKeyError`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-signing-authority.ts#L16)
...
### [`MessageId`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L108)
...
### [`MessageId`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L102)
...
### [`OperationId`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L99)
...
### [`OperationId`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L93)
...
### [`PrincipalId`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L90)
...
### [`PrincipalId`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identity-values.ts#L84)
...
### [`Registry`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry.ts#L20)
...
### [`RegistryConnectionError`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/client.ts#L53)
...
### [`RegistryInvalidResponseError`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/client.ts#L63)
...
### [`RegistryListRequest`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/operations.ts#L72)
...
### [`RegistryListRequest`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/operations.ts#L67)
...
### [`RegistryListResult`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/operations.ts#L87)
...
### [`RegistryLookupRequest`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/operations.ts#L63)
...
### [`RegistryLookupRequest`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/operations.ts#L51)
...
### [`RegistryLookupResult`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/operations.ts#L82)
...
### [`RegistryRegisterRequest`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/operations.ts#L47)
...
### [`RegistryRegisterRequest`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/operations.ts#L39)
...
### [`RegistryRegisterResult`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/operations.ts#L75)
...
### [`RegistryRequestTimeoutError`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/client.ts#L58)
...
### [`SignedMessage`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/signed-message.ts#L145)
...
### [`SignedMessage`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/signed-message.ts#L460)
...
### [`SignedMessageSigningError`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/signed-message.ts#L289)
...
### [`SignedMessageVerificationError`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/signed-message.ts#L294)
...
### [`VerifiedAgentCard`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-card.ts#L228)
...
### [`VerifiedAgentRequest`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registered-agent-request.ts#L6)
...
### [`VerifiedSignedMessage`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/signed-message.ts#L283)
