...
### [`AgentCard (type)`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-card.ts#L144)
...
### [`AgentCard (value)`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-card.ts#L439)
...
### [`AgentCardDigest (type)`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-card.ts#L61)
...
### [`AgentCardDigest (value)`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-card.ts#L54)
...
### [`AgentCardVerificationError`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-card.ts#L283)
...
### [`AgentId (type)`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identifiers.ts#L73)
...
### [`AgentId (value)`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identifiers.ts#L67)
...
### [`AgentName (type)`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identifiers.ts#L96)
...
### [`AgentName (value)`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identifiers.ts#L85)
...
### [`PrincipalId (type)`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identifiers.ts#L82)
...
### [`PrincipalId (value)`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/identifiers.ts#L76)
...
### [`VerifiedAgentCard`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/agent-card.ts#L268)
...
#### [`RegistryServer`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/server.ts#L1)

_Namespace_

#### [`RegistryServer.StartupError`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/server.ts#L26)
...
#### [`RegistryServer.layer`](https://github.com/chughtapan/moltzap/blob/v2/v2/identity/src/registry/server.ts#L66)
