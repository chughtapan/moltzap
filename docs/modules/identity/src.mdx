...
signing, and request authentication."
---
...
### [`AgentCard (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/agent-card.ts#L145)
...
### [`AgentCard (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/agent-card.ts#L440)
...
### [`AgentCardDigest (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/agent-card.ts#L62)
...
### [`AgentCardDigest (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/agent-card.ts#L55)
...
### [`AgentCardVerificationError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/agent-card.ts#L284)
...
### [`AgentId (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/identifiers.ts#L73)
...
### [`AgentId (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/identifiers.ts#L67)
...
### [`AgentName (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/identifiers.ts#L96)
...
### [`AgentName (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/identifiers.ts#L85)
...
### [`AgentSigningAuthority (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/agent-key.ts#L274)
...
### [`AgentSigningAuthority (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/agent-key.ts#L361)
...
### [`AgentSigningError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/http-signature.ts#L31)
...
### [`AuthenticatedHttp`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/authenticated-http.ts#L57)
...
### [`AuthenticationFailedError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/http-errors.ts#L12)
...
### [`Ed25519PublicKey (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/agent-key.ts#L240)
...
### [`Ed25519PublicKey (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/agent-key.ts#L209)
...
### [`InternalServerError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/http-errors.ts#L60)
...
### [`InvalidAgentPrivateKeyError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/agent-key.ts#L279)
...
### [`MalformedRequestError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/http-errors.ts#L6)
...
### [`MessageId (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/signed-message.ts#L40)
...
### [`MessageId (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/signed-message.ts#L37)
...
### [`MethodNotAllowedError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/http-errors.ts#L24)
...
### [`MOLTZAP_VERSION`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/version.ts#L4)
...
### [`OverloadedError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/http-errors.ts#L48)
...
### [`PayloadTooLargeError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/http-errors.ts#L36)
...
### [`PrincipalId (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/identifiers.ts#L82)
...
### [`PrincipalId (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/identifiers.ts#L76)
...
### [`RouteNotFoundError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/http-errors.ts#L18)
...
### [`SignedMessage (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/signed-message.ts#L154)
...
### [`SignedMessage (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/signed-message.ts#L469)
...
### [`SignedMessageSigningError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/signed-message.ts#L298)
...
### [`SignedMessageVerificationError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/signed-message.ts#L303)
...
### [`UnavailableError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/http-errors.ts#L54)
...
### [`UnsupportedMediaTypeError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/http-errors.ts#L42)
...
### [`VerifiedAgentCard`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/agent-card.ts#L269)
...
### [`VerifiedAgentRequest`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/authenticated-http.ts#L35)
...
### [`VerifiedSignedMessage`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/signed-message.ts#L292)
...
### [`VersionMismatchError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/http-errors.ts#L30)
...
#### [`Registry`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry.ts#L24)
...
#### [`RegistryConnectionError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L27)
...
#### [`RegistryInvalidResponseError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L37)
...
#### [`RegistryRequestTimeoutError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L32)
...
#### [`OperationId (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L24)
...
#### [`RegistryListRequest (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L84)
...
#### [`RegistryListResult`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L99)
...
#### [`RegistryLookupRequest (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L75)
...
#### [`RegistryLookupResult`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L94)
...
#### [`RegistryRegisterRequest (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L59)
...
#### [`RegistryRegisterResult`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L87)
...
#### [`OperationId (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L21)
...
#### [`RegistryListRequest (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L79)
...
#### [`RegistryLookupRequest (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L63)
...
#### [`RegistryRegisterRequest (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/contract.ts#L51)
...
#### [`StartupError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/server.ts#L142)
...
#### [`layer`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/server.ts#L182)
