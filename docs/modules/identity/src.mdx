...
#### [`StartupError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/server.ts#L28)
...
#### [`layer`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/src/registry/server.ts#L68)
