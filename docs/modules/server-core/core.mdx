...
### [`createCoreApp`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/core/app.ts#L40)
...
### [`ServerBootFailedError`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/core/app.ts#L18)
