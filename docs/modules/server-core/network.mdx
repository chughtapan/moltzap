...
### [`applyOutboundWebhookCap`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/network/outbound-webhook-cap.ts#L45)
...
### [`connectAgent`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/network/connect.handlers.ts#L501)
...
### [`connectApp`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/network/connect.handlers.ts#L509)
