...
### [`connectAgent`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/network/connect.handlers.ts#L497)
...
### [`connectApp`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/network/connect.handlers.ts#L505)
