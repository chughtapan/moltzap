...
### [`connectAgent`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/network/connect.handlers.ts#L469)
...
### [`connectApp`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/network/connect.handlers.ts#L477)
