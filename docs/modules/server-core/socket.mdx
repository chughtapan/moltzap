...
### [`AppConnection`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L56)
...
### [`Connection`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L66)
...
### [`ConnectionManager`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L170)
...
### [`TransitionOutcome`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L77)
