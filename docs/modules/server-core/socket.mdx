...
### [`PrincipalBoundaryCanaries`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/principal.types-check.ts#L86)
...
### [`principalCanaryRefs`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/principal.types-check.ts#L95)
