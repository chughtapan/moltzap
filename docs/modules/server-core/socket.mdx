...
### [`AgentConnection`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L89)
...
### [`AgentContext`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L29)
...
### [`agentContextFrom`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L45)
...
### [`AgentStatus`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L23)
...
### [`Connection`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L99)
...
### [`ConnectionManager`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L176)
...
### [`connectionManagerLive`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L405)
...
### [`ConnectionManagerTag`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L400)
...
### [`ConnectionTag`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L394)
...
### [`PrincipalBoundaryCanaries`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/principal.types-check.ts#L73)
...
### [`principalCanaryRefs`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/principal.types-check.ts#L81)
...
### [`TransitionOutcome`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L107)
...
### [`UnauthenticatedConnection`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L83)
