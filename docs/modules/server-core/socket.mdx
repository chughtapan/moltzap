...
### [`agentContextFrom`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/context.ts#L37)
...
### [`AppConnection`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L118)
...
### [`AppContext`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/context.ts#L23)
...
### [`ConnectionManager`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L232)
...
### [`Originator`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L77)
...
### [`PrincipalBoundaryCanaries`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/principal.types-check.ts#L101)
...
### [`principalCanaryRefs`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/principal.types-check.ts#L112)
...
### [`sendRpcToClient`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L30)
...
### [`UnauthenticatedConnection`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L106)
...
### [`WebSocketRef`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L82)
