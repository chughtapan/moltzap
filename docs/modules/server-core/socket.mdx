...
description: "Server WebSocket/session runtime boundary."
---
...
### [`AppTags`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/layer-tags.ts#L102)
...
### [`ConnectionManager`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/connection.ts#L188)
...
### [`makeCoreSocketHandler`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/server-socket.ts#L17)
...
### [`makeRequirementMiddlewareLayers`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/auth-middleware-layers.ts#L347)
...
### [`narrowByPolicy`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/principal-gate.ts#L99)
...
### [`peekLiveArm`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/socket/principal-gate.ts#L44)
