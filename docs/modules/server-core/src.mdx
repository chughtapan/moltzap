...
### [`ConfigLoadError`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/config.ts#L153)
...
### [`ConfigLoadErrorKind`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/config.ts#L151)
...
### [`loadStandaloneConfig`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/config.ts#L923)
...
### [`LoadStandaloneConfigInput`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/config.ts#L914)
...
### [`StandaloneBootPlan`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/config.ts#L117)
