...
### [`authorizeConversationCreateCapacityOnly`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/conversation/requirements/index.ts#L24)
...
### [`obtainConversationSendAccess`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/conversation/requirements/index.ts#L49)
