...
### [`guardConversationNotArchived`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/conversation/requirements/send-access.ts#L107)
...
### [`guardReplyTarget`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/conversation/requirements/send-access.ts#L123)
...
### [`guardTaskActive`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/conversation/requirements/send-access.ts#L86)
...
### [`obtainConversationSendAccess`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/conversation/requirements/send-access.ts#L29)
