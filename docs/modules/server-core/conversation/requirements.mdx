...
### [`guardConversationNotArchived`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/conversation/requirements/send-access.ts#L103)
...
### [`guardTaskActive`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/conversation/requirements/send-access.ts#L82)
