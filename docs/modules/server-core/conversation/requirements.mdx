...
### [`authorizeConversationCreateCapacityOnly`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/conversation/requirements/create-authorization.ts#L15)
