...
### [`agentPresenceSubscribe`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/network/presence/handlers.ts#L67)
...
### [`appPresenceSubscribe`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/network/presence/handlers.ts#L83)
