...
### [`DispatchAdmissionConversations`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/admission.service.ts#L107)
...
### [`DispatchAdmissionResult`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/admission.service.ts#L74)
...
### [`DispatchAdmissionService`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/admission.service.ts#L160)
...
### [`dispatchAdmissionServiceLive`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/layer.ts#L46)
...
### [`DispatchAdmissionServiceTag`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/layer.ts#L27)
...
### [`dispatchRequest`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/handlers.ts#L71)
...
### [`EnqueueDispatchRequestArgs`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/admission.service.ts#L94)
...
### [`LeaseInvalidError`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/lease-registry.ts#L167)
...
### [`LeaseRecord`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/lease-registry.ts#L136)
...
### [`leaseRecordToWire`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/lease-registry.ts#L535)
...
### [`LeaseRegistry`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/lease-registry.ts#L291)
...
### [`LeaseRegistryDeps`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/lease-registry.ts#L429)
...
### [`leaseRegistryLive`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/layer.ts#L32)
...
### [`LeaseRegistryTag`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/layer.ts#L21)
...
### [`LeaseState`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/lease-registry.ts#L115)
...
### [`LeaseVerdict`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/lease-registry.ts#L126)
...
### [`makeLeaseRegistry`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/lease-registry.ts#L1389)
...
### [`ModeratorBoundLeaseBinding`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/lease-registry.ts#L100)
