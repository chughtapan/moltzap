...
### [`DispatchAdmissionService`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/admission.service.ts#L95)
...
### [`EnqueueDispatchRequestArgs`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/admission.service.ts#L66)
...
### [`leaseRegistryLive`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/layer.ts#L30)
...
### [`LeaseRegistryTag`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/dispatch/layer.ts#L19)
