---
title: "server-core/http"
description: "HTTP server construction barrel."
---
...
### [`makeCoreHttpApp`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/http/routes.ts#L85)
...
### [`makeNodeHttpServer`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/http/node-http-server.ts#L7)
