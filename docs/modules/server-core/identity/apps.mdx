...
### [`callAppRpc`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/callback-rpc.ts#L17)
...
### [`installDefaultApp`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/default-app.ts#L99)
...
### [`wrapHookEffectWithEnvelope`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/callback-rpc.ts#L63)
