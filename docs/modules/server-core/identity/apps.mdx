...
### [`AppAuthService`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/auth.service.ts#L34)
...
### [`AppAuthServiceLive`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/layer.ts#L19)
...
### [`AppAuthServiceTag`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/layer.ts#L10)
...
### [`AppEndpoint`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/registry.ts#L16)
...
### [`AppEndpointRegistry`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/endpoint-registry.ts#L11)
...
### [`AppEndpointRegistryLive`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/layer.ts#L27)
...
### [`AppEndpointRegistryTag`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/layer.ts#L15)
...
### [`AppRegistration`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/registry.ts#L31)
...
### [`AppRegistry`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/registry.ts#L46)
...
### [`installDefaultApp`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/default-app.ts#L100)
...
### [`wrapHookEffectWithEnvelope`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/callback-rpc.ts#L55)
