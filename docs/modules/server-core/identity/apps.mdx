---
title: "server-core/identity/apps"
description: "App identity and endpoint registration barrel."
---
...
### [`AppAuthService`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/auth.service.ts#L37)
...
### [`appAuthServiceLive`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/layer.ts#L23)
...
### [`AppAuthServiceTag`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/layer.ts#L12)
...
### [`AppEndpoint`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/registry.ts#L15)
...
### [`AppEndpointRegistry`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/endpoint-registry.ts#L12)
...
### [`appEndpointRegistryLive`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/layer.ts#L32)
...
### [`AppEndpointRegistryTag`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/layer.ts#L18)
...
### [`AppRegistration`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/registry.ts#L30)
...
### [`AppRegistry`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/registry.ts#L45)
...
### [`callAppRpc`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/callback-rpc.ts#L18)
...
### [`installDefaultApp`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/default-app.ts#L102)
...
### [`wrapHookEffectWithEnvelope`](https://github.com/chughtapan/moltzap/blob/main/packages/server/src/identity/apps/callback-rpc.ts#L74)
