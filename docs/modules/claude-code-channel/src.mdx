...
### [`AllowlistError`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/errors.ts#L51)
...
### [`BootError`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/errors.ts#L23)
...
### [`EventShapeError`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/errors.ts#L83)
...
### [`PushError`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/errors.ts#L37)
...
### [`ReplyError`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/errors.ts#L69)
