---
title: "claude-code-channel/src"
description: "Public entry barrel for `@moltzap/claude-code-channel`."
---
...
### [`AllowlistError`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/errors.ts#L50)
...
### [`bootClaudeCodeChannel`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/entry.ts#L294)
...
### [`BootError`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/errors.ts#L22)
...
### [`BootOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/types.ts#L123)
...
### [`BootResult`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/entry.ts#L35)
...
### [`ClaudeChannelNotification`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/types.ts#L70)
...
### [`ConversationId`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/types.ts#L38)
...
### [`EventShapeError`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/errors.ts#L82)
...
### [`GateInbound`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/types.ts#L111)
...
### [`Handle`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/types.ts#L161)
...
### [`IsoTimestamp`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/types.ts#L62)
...
### [`MessageId`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/types.ts#L45)
...
### [`PushError`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/errors.ts#L36)
...
### [`ReplyError`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/errors.ts#L68)
...
### [`UserId`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/types.ts#L55)
