...
### [`bootClaudeCodeChannel`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/entry.ts#L313)
...
### [`BootResult`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/entry.ts#L36)
...
### [`Handle`](https://github.com/chughtapan/moltzap/blob/main/packages/claude-code-channel/src/types.ts#L162)
