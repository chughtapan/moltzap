...
### [`default`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/openclaw-channel/src/openclaw-entry.ts#L1146)
...
### [`makeMoltZapChannelConfigJsonSchema`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/openclaw-channel/src/openclaw-entry.ts#L213)
