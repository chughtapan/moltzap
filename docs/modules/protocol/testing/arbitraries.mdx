...
### [`arbitraryConfidentCall`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/arbitraries/rpc.ts#L132)
...
### [`confidentOracleMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/arbitraries/rpc.ts#L102)
