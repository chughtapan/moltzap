...
### [`applyCall`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L185)
...
### [`authorizationOutcome`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L139)
