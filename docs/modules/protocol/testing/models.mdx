...
### [`applyCall`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L186)
...
### [`authorizationOutcome`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L140)
...
### [`isIdempotent`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L92)
...
### [`RpcModelResult`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L63)
