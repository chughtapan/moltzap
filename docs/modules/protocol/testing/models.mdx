...
### [`applyCall`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L188)
...
### [`authorizationOutcome`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L141)
...
### [`isIdempotent`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L94)
...
### [`RpcModelResult`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L65)
