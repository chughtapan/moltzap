...
### [`applyCall`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L193)
...
### [`authorizationOutcome`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/models/dispatch.ts#L146)
