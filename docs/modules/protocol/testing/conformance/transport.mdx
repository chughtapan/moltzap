...
### [`acquireProxiedClient`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/_helpers.ts#L61)
...
### [`ADVERSITY_CATEGORY`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/_helpers.ts#L27)
...
### [`adversityViolation`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/_helpers.ts#L34)
...
### [`attachToxic`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/_helpers.ts#L115)
...
### [`createOneOnOneConversation`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/_helpers.ts#L220)
...
### [`DEFAULT_CAPTURE_CAPACITY`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/_helpers.ts#L28)
...
### [`proxy`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/_helpers.ts#L113)
...
### [`proxyName`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/_helpers.ts#L52)
...
### [`ToxicBodyParams`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/_helpers.ts#L112)
...
### [`TRANSPORT_PROPERTIES`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/index.ts#L52)
...
### [`unavailable`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/_helpers.ts#L114)
...
### [`withToxicProxy`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/_helpers.ts#L124)
