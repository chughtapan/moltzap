...
### [`registerTimeoutSurface`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/transport/adversity-timeout-surface.ts#L27)
