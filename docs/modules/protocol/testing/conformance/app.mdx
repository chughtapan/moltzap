...
### [`ABANDON_OBSERVATION_BUFFER_MS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L25)
...
### [`ABANDON_POLL_EXTRA_MS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L35)
...
### [`APP_PROPERTIES`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/index.ts#L59)
...
### [`ConsumedFrameView`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L91)
...
### [`DISPATCH_ADMISSION_CATEGORY`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L16)
...
### [`dispatchAdmissionViolation`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L68)
...
### [`FAST_ACK_THRESHOLD_MS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L51)
...
### [`FORBIDDEN_ERROR_TAG`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L29)
...
### [`freshMessageId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L100)
...
### [`HOLD_DRAIN_BUFFER_MS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L60)
...
### [`HOLD_RELEASE_MARGIN_MS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L56)
...
### [`isUuidV4`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L114)
...
### [`LeaseIdOnlyView`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L87)
...
### [`makeDispatchTestDriver`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_driver.ts#L923)
...
### [`MISSING_TOPOLOGY_REASON`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/app-disconnect-fail-policy.ts#L40)
...
### [`ModeratorHandle`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_driver.ts#L194)
...
### [`NEGATIVE_OBSERVABILITY_WINDOW_MS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L27)
...
### [`NO_SECOND_RELEASE_WINDOW_MS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L46)
...
### [`registerAppDisconnectFailPolicy`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/app-disconnect-fail-policy.ts#L54)
...
### [`registerDispatchAuthorizeTimeoutSynthesizesDeny`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatch-authorize-timeout.ts#L18)
...
### [`registerDispatchAuthorizeVerdictResolves`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatch-authorize-verdict.ts#L28)
...
### [`registerDispatchLeaseConsumedFiresOnFirstSend`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatch-lease-consumed-fires-on-first-send.ts#L20)
...
### [`registerDispatchLeaseConsumedSuppressedOnSecondSend`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatch-lease-consumed-suppressed-on-second.ts#L18)
...
### [`registerDispatchLeaseExpiredFiresOnTtl`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatch-lease-expired-fires-on-ttl.ts#L18)
...
### [`registerDispatchLeaseExpiredSuppressedOnConsumeBeforeTtl`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatch-lease-expired-suppressed-on-consume.ts#L19)
...
### [`registerDispatchLeaseGetModeratorSeesRecord`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatch-lease-get-moderator-sees.ts#L17)
...
### [`registerDispatchReleaseFiresAfterResolve`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatch-release-after-resolve.ts#L41)
...
### [`registerDispatchReleaseSkippedOnAbandoned`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatch-release-skipped-on-abandoned.ts#L16)
...
### [`registerDispatchRequestAckMintsLease`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatch-request-ack.ts#L16)
...
### [`registerDispatchRequestRecipientDisconnectAbandons`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatch-request-recipient-disconnect.ts#L16)
...
### [`registerReleaseForOneLeaseDoesNotWaitOnAnother`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/release-for-one-lease-does-not-wait.ts#L21)
...
### [`registerSameConversationDispatchRequestsConcurrent`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/same-conv-dispatch-requests-concurrent.ts#L17)
...
### [`registerSlowFirstDoesNotDelaySecondAck`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/slow-first-does-not-delay-second-ack.ts#L16)
...
### [`ReleaseFrameView`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L82)
...
### [`SHORT_LEASE_TIMEOUT_MS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L19)
...
### [`TIMEOUT_RELEASE_WAIT_MS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L41)
...
### [`withDriver`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_helpers.ts#L126)
