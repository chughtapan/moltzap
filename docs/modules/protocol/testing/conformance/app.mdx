...
### [`makeDispatchTestDriver`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/_driver.ts#L893)
...
### [`registerDispatchesGetModeratorSeesRecord`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/dispatches-get-moderator-sees.ts#L13)
...
### [`registerSameConversationDispatchesConcurrent`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/testing/conformance/app/same-conv-dispatches-concurrent.ts#L13)
