...
### [`agentCallableGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L91)
...
### [`agentCallableMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L25)
...
### [`AnyAgentCallableRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L61)
...
### [`AnyNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L65)
...
### [`AnyServerRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L58)
...
### [`notificationDefinitions`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L52)
...
### [`notificationRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L101)
...
### [`reverseRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L112)
...
### [`ServerHandler`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L87)
...
### [`ServerHandlers`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L82)
...
### [`serverInboundGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L75)
...
### [`serverInboundMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L40)
