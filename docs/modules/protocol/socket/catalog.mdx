...
### [`agentCallableGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L99)
...
### [`agentCallableMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L27)
...
### [`AnyAgentCallableRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L69)
...
### [`AnyNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L73)
...
### [`AnyServerRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L66)
...
### [`notificationRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L109)
...
### [`reverseRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L120)
...
### [`ServerHandler`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L95)
...
### [`ServerHandlers`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L90)
...
### [`serverInboundGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L83)
...
### [`serverInboundMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L45)
