...
### [`agentCallableGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L78)
...
### [`agentCallableMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L17)
...
### [`AnyAgentCallableRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L48)
...
### [`AnyNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L52)
...
### [`AnyServerRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L45)
...
### [`notificationDefinitions`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L40)
...
### [`notificationRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L88)
...
### [`reverseRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L99)
...
### [`ServerHandler`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L74)
...
### [`ServerHandlers`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L69)
...
### [`serverInboundGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L62)
...
### [`serverInboundMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L30)
