...
### [`agentCallableGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L141)
...
### [`AnyAgentCallableRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L105)
...
### [`AnyAppCallableRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L109)
...
### [`AnyAppCallbackRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L112)
...
### [`AnyNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L115)
...
### [`AnyServerRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L102)
...
### [`appCallableGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L146)
...
### [`notificationRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L156)
...
### [`reverseRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L171)
...
### [`ServerHandler`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L137)
...
### [`ServerHandlers`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L132)
...
### [`serverInboundGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/catalog/index.ts#L125)
