...
### [`AgentClientOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L1344)
...
### [`connectionId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L56)
...
### [`ConnectionId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L46)
...
### [`connectionIdSchema`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L49)
...
### [`MoltZapAgentClient`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L1351)
...
### [`MoltZapServer`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L263)
...
### [`MoltZapServerOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L83)
...
### [`MoltZapServerSession`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L68)
...
### [`newConnectionId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L59)
...
### [`openProtocolAgentClientSocket`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L440)
...
### [`ProtocolClientLifecycle`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L545)
...
### [`ReverseCallError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L155)
...
### [`ReverseClient`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L173)
...
### [`RPC_TIMEOUT_MS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L66)
...
### [`ServerSocketWrite`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L63)
