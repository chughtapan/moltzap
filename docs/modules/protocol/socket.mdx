...
### [`ClientConnectError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L113)
...
### [`ClientDefinitionError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L100)
...
### [`ClientDefinitionPayload`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L94)
...
### [`ClientDefinitionSuccess`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L97)
...
### [`ClientLifecycleOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L192)
...
### [`ClientRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L90)
...
### [`isDispatchAuthorizeRequest`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/reverse-callbacks.ts#L28)
...
### [`isMessagesAuthorizeRequest`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/reverse-callbacks.ts#L38)
...
### [`MessagesAuthorizeRequest`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/reverse-callbacks.ts#L19)
...
### [`MoltZapAgentClient`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/agent-client.ts#L47)
...
### [`MoltZapServer`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L293)
...
### [`openProtocolAgentClientSocket`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L503)
...
### [`openProtocolAppClientSocket`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L520)
...
### [`ProtocolClientLifecycle`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L625)
...
### [`ReverseCallbackError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L153)
...
### [`ReverseCallbackHandlers`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L228)
...
### [`ReverseCallbackRequest`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L156)
...
### [`ReverseCallbackSuccess`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L150)
...
### [`ReverseCallbackTag`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L142)
...
### [`ReverseCallError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L137)
...
### [`ReverseClient`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/server.ts#L196)
...
### [`RPC_TIMEOUT_MS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L76)
...
### [`RpcCallOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/socket/lifecycle.ts#L85)
