...
### [`ConversationSendAccess`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/capabilities/conversation-send-access.ts#L27)
...
### [`ConversationSendAccessValue`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/capabilities/conversation-send-access.ts#L19)
