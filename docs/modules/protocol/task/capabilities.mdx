...
### [`MessageSendPermission`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/capabilities/message-send-permission.ts#L31)
...
### [`MessageSendPermissionValue`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/capabilities/message-send-permission.ts#L15)
...
### [`ObtainMessageSendPermissionInput`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/capabilities/message-send-permission.ts#L42)
