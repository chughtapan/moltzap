...
### [`assertAppOwnsTask`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/capabilities/assert-capability-matches-task.ts#L81)
...
### [`assertConversationInTaskMatches`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/capabilities/assert-capability-matches-task.ts#L49)
...
### [`assertTaskReadAccessMatchesTask`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/capabilities/assert-capability-matches-task.ts#L37)
