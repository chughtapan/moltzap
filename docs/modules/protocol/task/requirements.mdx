...
### [`assertAppOwnsTask`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/requirements/assert-requirement-matches-task.ts#L37)
...
### [`assertTaskReadAccessMatchesTask`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/requirements/assert-requirement-matches-task.ts#L14)
