...
### [`assertAppOwnsTask`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/requirements/assert-requirement-matches-task.ts#L43)
...
### [`assertTaskReadAccessMatchesTask`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/requirements/assert-requirement-matches-task.ts#L17)
...
### [`TaskReadAccess`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/requirements/task-read-access.ts#L23)
