---
title: "protocol/task"
description: "Public barrel for the opaque task label and the app send-hook failure."
---
...
### [`HookBlockedError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/hooks.ts#L14)
...
### [`taskId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/ids.ts#L10)
...
### [`TaskId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/ids.ts#L8)
