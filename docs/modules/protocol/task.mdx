...
### [`agentCallableTaskRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L373)
...
### [`appCallableTaskRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L380)
...
### [`HookBlockedError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L82)
...
### [`InitialConversationInput`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L153)
...
### [`Task`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L104)
...
### [`taskCallbackMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L383)
...
### [`TaskClosedNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L367)
...
### [`TaskCreatedNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L358)
...
### [`TaskFailedNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L347)
...
### [`taskNotifications`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L386)
...
### [`TaskParticipant`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L118)
...
### [`TaskRequest`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L181)
...
### [`TaskStatus`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L92)
...
### [`TaskUpdate`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L318)
...
### [`TaskUpdateParams`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L302)
...
### [`TaskUpdateResult`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/tasks.ts#L305)
