...
### [`AppId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/ids.ts#L25)
...
### [`DEFAULT_APP_ID`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/task/ids.ts#L31)
