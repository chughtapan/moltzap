...
### [`ContactPolicyAllowsReach`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/identity/contacts/requirements/contact-policy-allows-reach.ts#L16)
...
### [`ContactPolicyAllowsReachValue`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/identity/contacts/requirements/contact-policy-allows-reach.ts#L7)
