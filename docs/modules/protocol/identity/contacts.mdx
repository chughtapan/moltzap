...
### [`ContactAcceptedNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/identity/contacts/protocol.ts#L108)
...
### [`ContactNotFoundError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/identity/contacts/protocol.ts#L30)
...
### [`ContactRequestNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/identity/contacts/protocol.ts#L103)
...
### [`ContactsAccept`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/identity/contacts/protocol.ts#L79)
...
### [`ContactsAdd`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/identity/contacts/protocol.ts#L68)
...
### [`ContactsById`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/identity/contacts/protocol.ts#L87)
...
### [`ContactsList`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/identity/contacts/protocol.ts#L54)
...
### [`NotInContactsError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/identity/contacts/protocol.ts#L23)
