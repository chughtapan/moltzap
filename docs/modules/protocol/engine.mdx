...
description: "Public barrel for the engine layer — the descriptor-aggregate machinery
...
### [`AgentCallableGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/client-callable-groups.ts#L135)
...
### [`AppCallableGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/client-callable-groups.ts#L145)
...
### [`AppCallbackHandlers`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/handlers.ts#L96)
...
### [`AppCallbackInboundRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/handlers.ts#L94)
...
### [`callerAgentId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/current-principal.ts#L66)
...
### [`CapabilityRequirement`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/requirements.ts#L43)
...
### [`capRequirementsOf`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/requirements.ts#L100)
...
### [`ContactPolicyAllowsReachMw`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/cap-middlewares.ts#L73)
...
### [`ConversationInTaskMw`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/cap-middlewares.ts#L55)
...
### [`ConversationSendAccessMw`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/cap-middlewares.ts#L60)
...
### [`CurrentPrincipal`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/current-principal.ts#L54)
...
### [`HandlerSlot`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/handlers.ts#L25)
...
### [`isUnauthenticatedMethod`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/server-engine-group.ts#L58)
...
### [`makeServerProtocolLayer`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/server-engine.ts#L60)
...
### [`MiddlewareRequirementKey`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/cap-middlewares.ts#L89)
...
### [`MwForRequirement`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/cap-middlewares.ts#L125)
...
### [`MwStackFor`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/cap-middlewares.ts#L146)
...
### [`NotificationRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/rpc-method-groups.ts#L105)
...
### [`Principal`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/current-principal.ts#L41)
...
### [`PrincipalGateMw`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/cap-middlewares.ts#L50)
...
### [`principalRequirementOf`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/requirements.ts#L68)
...
### [`PrincipalRequirementOf`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/requirements.ts#L80)
...
### [`Requirement`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/requirements.ts#L57)
...
### [`requirementMiddleware`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/cap-middlewares.ts#L107)
...
### [`requiresClaimed`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/requirements.ts#L89)
...
### [`ReverseRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/rpc-method-groups.ts#L136)
...
### [`ServerEngineLayer`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/server-engine.ts#L105)
...
### [`ServerEngineRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/server-engine-group.ts#L178)
...
### [`TaskReadAccessMw`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/cap-middlewares.ts#L68)
...
### [`UNAUTHENTICATED_METHODS`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/server-engine-group.ts#L46)
...
### [`UnauthenticatedMethod`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/server-engine-group.ts#L49)
...
### [`WsServerEngineRpcGroup`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/engine/server-engine-group.ts#L200)
