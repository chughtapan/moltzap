...
### [`agentClientRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L74)
...
### [`AnyAgentClientRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L102)
...
### [`AnyNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L109)
...
### [`AnyServerRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L100)
...
### [`AnyTaskCallbackRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L107)
...
### [`AnyTaskMasterRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L104)
...
### [`decodeClientInbound`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L254)
...
### [`DecodedClientInbound`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L152)
...
### [`DecodedResponseError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L126)
...
### [`DecodedResponseSuccess`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L113)
...
### [`DecodedServerInbound`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L137)
...
### [`decodeServerInbound`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L220)
...
### [`notificationDefinitions`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L93)
...
### [`PROTOCOL_VERSION`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/version.ts#L2)
...
### [`RegisteredTaggedError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L55)
...
### [`serverRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L86)
...
### [`taskMasterRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L81)
