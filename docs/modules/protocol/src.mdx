...
### [`agentClientRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L41)
...
### [`AnyAgentClientRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L69)
...
### [`AnyAppCallbackRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L72)
...
### [`AnyNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L74)
...
### [`AnyServerRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L67)
...
### [`appCallableRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L48)
...
### [`brandedId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L143)
...
### [`brandedString`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L45)
...
### [`BrandedStringOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L24)
...
### [`checkProtocolRange`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/version.ts#L143)
...
### [`closedStructGuard`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L246)
...
### [`compareProtocolVersion`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/version.ts#L71)
...
### [`dateTimeStringSchema`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L188)
...
### [`DecodedResponseError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L91)
...
### [`DecodedResponseSuccess`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L78)
...
### [`DecodedServerInbound`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L102)
...
### [`decodeServerInbound`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L167)
...
### [`decodesStrictly`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L229)
...
### [`formatString`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L157)
...
### [`InvalidProtocolVersionError`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/version.ts#L29)
...
### [`ListCursor`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L195)
...
### [`listCursorSchema`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L204)
...
### [`notificationDefinitions`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L60)
...
### [`serverRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/rpc-registry.ts#L53)
...
### [`STRICT_DECODE`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L221)
...
### [`stringEnum`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L168)
...
### [`WireStringFormat`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/schema-primitives.ts#L21)
