...
### [`_TypedDispatcherCanarySink`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/typed-dispatcher.types-check.ts#L204)
...
### [`AgentClientConnection`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/connection.ts#L158)
...
### [`AgentClientConnectionConfig`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/connection.ts#L223)
...
### [`AgentClientHandlers`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/handlers.ts#L116)
...
### [`CapsUnionOf`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/handlers.ts#L147)
...
### [`HandlerTable`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/handlers.ts#L73)
...
### [`makeTaskMasterConnection`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/connection.ts#L292)
...
### [`ServerConnection`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/connection.ts#L145)
...
### [`ServerConnectionConfig`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/connection.ts#L204)
...
### [`ServerHandlers`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/handlers.ts#L98)
...
### [`ServerInboundRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/handlers.ts#L88)
...
### [`TaskMasterConnection`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/connection.ts#L178)
...
### [`TaskMasterConnectionConfig`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/connection.ts#L237)
...
### [`TaskMasterHandlers`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/handlers.ts#L132)
...
### [`TaskMasterInboundRpcDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/handlers.ts#L130)
