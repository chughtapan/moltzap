...
### [`CapabilitiesOf`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/capabilities.ts#L76)
...
### [`CapabilityDescriptor`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/capabilities.ts#L35)
...
### [`CapabilityProviderTable`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/capabilities.ts#L56)
