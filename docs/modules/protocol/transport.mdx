...
### [`makeServerProtocolLayer`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/native-server-engine.ts#L69)
...
### [`PrincipalResolution`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/native-server-engine.ts#L50)
...
### [`ServerEngineLayer`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/transport/native-server-engine.ts#L97)
