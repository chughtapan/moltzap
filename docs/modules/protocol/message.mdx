...
### [`DispatchLeaseConsumed`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L139)
...
### [`DispatchLeaseExpired`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L150)
...
### [`DispatchLeaseGet`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L192)
