...
### [`agentCallableDispatchRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L209)
...
### [`appCallableDispatchRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L212)
...
### [`DispatchAdmissionDecision`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L70)
...
### [`dispatchAuthorize`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L124)
...
### [`dispatchCallbackMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L215)
...
### [`dispatchLeaseConsumed`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L146)
...
### [`dispatchLeaseExpired`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L158)
...
### [`dispatchLeaseGet`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L200)
...
### [`dispatchNotifications`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L218)
...
### [`dispatchRelease`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L133)
...
### [`dispatchRequest`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L91)
