...
### [`agentCallableDispatchRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L216)
...
### [`appCallableDispatchRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L219)
...
### [`dispatchAuthorize`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L131)
...
### [`dispatchCallbackMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L222)
...
### [`dispatchLeaseConsumed`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L153)
...
### [`dispatchLeaseExpired`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L165)
...
### [`dispatchLeaseGet`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L207)
...
### [`dispatchNotifications`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L225)
...
### [`dispatchRelease`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L140)
...
### [`dispatchRequest`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/dispatch.ts#L95)
