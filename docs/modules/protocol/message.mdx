...
### [`agentCallableMessageRpcMethods`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/index.ts#L340)
...
### [`DispatchDecision`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/index.ts#L306)
...
### [`dispatchDecisionSchema`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/index.ts#L327)
...
### [`messageNotifications`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/index.ts#L346)
...
### [`MessageReceivedNotification`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/index.ts#L260)
...
### [`MessageReceivedNotificationDefinition`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/index.ts#L268)
...
### [`MessageWithDispatchDecision`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/index.ts#L319)
...
### [`messageWithDispatchDecisionSchema`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/index.ts#L335)
...
### [`validateDispatchDecision`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/message/index.ts#L311)
