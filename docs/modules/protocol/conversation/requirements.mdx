...
### [`ConversationInTaskValue`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/conversation/requirements/conversation-in-task.ts#L9)
...
### [`ConversationSendAccess`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/conversation/requirements/conversation-send-access.ts#L21)
