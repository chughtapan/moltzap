...
description: "Runtime connection identifiers shared by protocol socket lifecycle."
---
...
### [`connectionId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/runtime/connection.ts#L22)
...
### [`ConnectionId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/runtime/connection.ts#L19)
...
### [`newConnectionId`](https://github.com/chughtapan/moltzap/blob/main/packages/protocol/src/runtime/connection.ts#L24)
