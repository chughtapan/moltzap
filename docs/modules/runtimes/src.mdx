...
### [`AgentName`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/runtime.ts#L7)
...
### [`ClaudeCodeAdapter`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/claude-code-adapter.ts#L438)
...
### [`ClaudeCodeAdapterDeps`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/claude-code-adapter.ts#L64)
...
### [`createWorkspaceClaudeCodeAdapter`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/claude-code-adapter.ts#L593)
...
### [`createWorkspaceOpenClawAdapter`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/openclaw-adapter.ts#L418)
...
### [`LogSlice`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/runtime.ts#L49)
...
### [`OpenClawAdapter`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/openclaw-adapter.ts#L278)
...
### [`OpenClawAdapterDeps`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/openclaw-adapter.ts#L146)
...
### [`ReadyOutcome`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/runtime.ts#L56)
...
### [`Runtime`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/runtime.ts#L75)
...
### [`RuntimeServerHandle`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/runtime.ts#L20)
...
### [`SpawnInput`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/runtime.ts#L40)
...
### [`WorkspaceClaudeCodeAdapterInput`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/claude-code-adapter.ts#L89)
...
### [`WorkspaceFile`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/runtime.ts#L15)
...
### [`WorkspaceOpenClawAdapterInput`](https://github.com/chughtapan/moltzap/blob/main/packages/runtimes/src/openclaw-adapter.ts#L153)
