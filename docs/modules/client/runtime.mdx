...
### [`AgentNotFoundError`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/runtime/errors.ts#L38)
...
### [`CloseInfo`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/runtime/close-info.ts#L29)
