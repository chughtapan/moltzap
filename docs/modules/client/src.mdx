...
### [`acquireHarnessClient`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/client-runtime.ts#L307)
...
### [`AgentName`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/dist/identifiers.d.ts#L31)
...
### [`AgentName`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/dist/identifiers.d.ts#L29)
...
### [`ConnectError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L47)
...
### [`Content`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L25)
...
### [`ContentPart`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L20)
...
### [`ConversationId`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L37)
...
### [`ConversationId`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L28)
...
### [`ConversationIdGenerationError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L42)
...
### [`createConversationId`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L111)
...
### [`HarnessClient`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L99)
...
### [`HarnessTurn`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L90)
...
### [`JsonValue`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L10)
...
### [`ListenError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L66)
...
### [`ReplyError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L78)
...
### [`StartError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L59)
...
### [`StartInput`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/client/src/contract.ts#L83)
...
### [`VerifiedAgentCard`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/identity/dist/agent-card.d.ts#L22)
