...
### [`AppClientOptions`](https://github.com/chughtapan/moltzap/blob/main/protocol/dist/socket/app-client.d.ts#L13)
...
### [`MoltZapAppClient`](https://github.com/chughtapan/moltzap/blob/main/protocol/dist/socket/app-client.d.ts#L19)
