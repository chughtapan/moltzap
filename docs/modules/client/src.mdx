...
### [`MoltZapTMClient`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/tm-client.ts#L335)
...
### [`TMClientOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/tm-client.ts#L247)
