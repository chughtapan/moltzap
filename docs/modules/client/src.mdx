...
### [`AppCallbackContext`](https://github.com/chughtapan/moltzap/blob/main/protocol/dist/socket/app-client.d.ts#L14)

_Interface_

Carries context for app callback.

### [`AppCallbackHandlers`](https://github.com/chughtapan/moltzap/blob/main/protocol/dist/socket/app-callbacks.d.ts#L36)
...
### [`AppClientOptions`](https://github.com/chughtapan/moltzap/blob/main/protocol/dist/socket/app-client.d.ts#L18)

_Interface_

Configures app client.

### [`ContextOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/service.ts#L155)
...
### [`ConversationMeta`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/service.ts#L147)
...
### [`MoltZapAppClient`](https://github.com/chughtapan/moltzap/blob/main/protocol/dist/socket/app-client.d.ts#L25)

_Class_

Implements molt zap app client.

### [`MoltZapService`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/service.ts#L295)
...
### [`ServiceRpcError`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/service.ts#L135)
