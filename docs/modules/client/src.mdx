...
### [`acquireMoltzapdChild`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/moltzapd-child.ts#L375)
...
### [`ContextOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/service.ts#L89)
...
### [`harnessClientForProfile`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/moltzapd-child.ts#L421)
...
### [`MoltzapdChild`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/moltzapd-child.ts#L61)
...
### [`MoltzapdChildOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/moltzapd-child.ts#L67)
...
### [`MoltZapService`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/service.ts#L196)
...
### [`ServiceRpcError`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/service.ts#L83)
