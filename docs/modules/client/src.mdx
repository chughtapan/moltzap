...
### [`AppClientOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/app-client.ts#L157)
...
### [`MoltZapAppClient`](https://github.com/chughtapan/moltzap/blob/main/packages/client/src/app-client.ts#L245)
