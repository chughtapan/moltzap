...
### [`OpenClawSandboxConfig`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/agents/openclaw/configuration.ts#L22)
...
### [`OpenClawToolsConfig`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/agents/openclaw/configuration.ts#L19)
