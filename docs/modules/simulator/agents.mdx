...
### [`openClawRuntime`](https://github.com/chughtapan/moltzap/blob/main/packages/simulator/src/agents/openclaw/runtime.ts#L175)
...
### [`OpenClawRuntimeOptions`](https://github.com/chughtapan/moltzap/blob/main/packages/simulator/src/agents/openclaw/runtime.ts#L118)
