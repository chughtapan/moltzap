...
### [`CompletedLedgerReceipt`](https://github.com/chughtapan/moltzap/blob/main/packages/simulator/src/kernel/run.ts#L67)
...
### [`LedgerReceipt`](https://github.com/chughtapan/moltzap/blob/main/packages/simulator/src/kernel/run.ts#L91)
...
### [`SimulatorRunFailure`](https://github.com/chughtapan/moltzap/blob/main/packages/simulator/src/kernel/run.ts#L115)
