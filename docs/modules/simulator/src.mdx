...
### [`ProfileRunResult (type)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/cluster/profiles/result.ts#L38)
...
### [`ProfileRunResult (value)`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/cluster/profiles/result.ts#L21)
