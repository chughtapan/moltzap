...
description: "Compatible simulator network contracts and run-scoped services."
---
...
### [`AttachedEndpoint`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/router.ts#L55)
...
### [`EndpointInbox`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/endpoint.ts#L24)
...
### [`EndpointTransport`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/router.ts#L44)
...
### [`InboundLinkStage`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/link.ts#L69)
...
### [`LinkDriver`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/link.ts#L119)
...
### [`LinkDriverService`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/link.ts#L93)
...
### [`LinkPolicyLease`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/link.ts#L77)
...
### [`makeAgentHandle`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/participant.ts#L81)
...
### [`makeEndpoint`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/endpoint.ts#L109)
...
### [`makeParticipantHandle`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/participant.ts#L47)
...
### [`makeRouterStopReport`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/router.ts#L33)
...
### [`networkError`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/failure.ts#L40)
...
### [`NetworkOperation`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/failure.ts#L17)
...
### [`ParticipantIds`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/router.ts#L38)
...
### [`Router`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/router.ts#L61)
...
### [`RouterProvider`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/router.ts#L74)
...
### [`RouterProviderService`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/router.ts#L69)
...
### [`RouterStopped`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/router.ts#L17)
