...
### [`EndpointInbox`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/endpoint.ts#L20)
...
### [`makeEndpoint`](https://github.com/chughtapan/moltzap/blob/cutover/four-layer-v2/packages/simulator/src/network/endpoint.ts#L105)
