...
Creates messages, encrypts content with envelope encryption, routes to conversations, triggers delivery tracking, and broadcasts `messages/received` notifications to connected participants.
