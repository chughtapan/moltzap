...
description: Connection management and notification broadcasting
---
...
Fan-out notifications to all participants in a conversation:
...
The broadcaster looks up which connections are subscribed to the conversation and sends the notification to each one, skipping muted connections.
