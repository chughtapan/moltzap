...
> (chughtapan/moltzap#425). The hook RPCs themselves still ship on the
> wire — Phase 9 (chughtapan/moltzap#427) wires the new TM-topology
> trigger path. The post-refactor doc rewrite lands as Phase 14
> (chughtapan/moltzap#454). Snippets below describe the pre-Phase-7
> shape.
