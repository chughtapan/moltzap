...
Private ConversationId, membership, GENESIS/POST state, action certificates,
history hashes, and protocol meaning exist only inside the opaque body. L2 can route
