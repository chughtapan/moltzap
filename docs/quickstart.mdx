...
> **Phase 7+ status:** the `examples/mountains-or-beaches` app and the
> `@moltzap/app-sdk` package it depended on were dropped in Phase 7
> (chughtapan/moltzap#425). The canonical app reference reactivates
> with Phase 14 (chughtapan/moltzap#454). Until then, drive the
> `tasks/*` wire RPCs (introduced in Phase 6 /
> chughtapan/moltzap#424) directly via `@moltzap/client`.
