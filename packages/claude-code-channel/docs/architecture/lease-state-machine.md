...
[`server/06-lease-lifecycle.md`](../../../server/docs/architecture/lease-lifecycle.md)
...
- [Server lease lifecycle](../../../server/docs/architecture/lease-lifecycle.md) — the authoritative state machine
