...
### [`CapabilitiesOf`](./capabilities.ts#L117)
...
### [`CapabilityDescriptor`](./capabilities.ts#L98)
...
### [`DispatchAuth`](./capabilities.ts#L28)
...
### [`DispatchContext`](./capabilities.ts#L40)
...
### [`TaskMasterHandlers`](./handlers.ts#L90)
...
### [`TaskMasterInboundRpcDefinition`](./handlers.ts#L88)
