...
### [`InitialConversationInput`](./tasks.ts#L162)
...
### [`TaskRejectedError`](./tasks.ts#L79)
...
### [`TaskUpdateParams`](./tasks.ts#L309)
...
### [`TaskUpdateResult`](./tasks.ts#L313)
