...
- [WebSocket connection lifecycle](./ws-connection-lifecycle.md) — `/ws` upgrade path
- [Request → response handling](./request-response-handling.md) — frame handling once upgraded
