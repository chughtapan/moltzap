...
- [WebSocket connection lifecycle](./ws-connection-lifecycle.md) — `conn.write` set up at connection time
- [Server-initiated callback](./server-initiated-callback.md) — `dispatch/release` notification emitted post-verdict
