...
- [Service layer composition](./service-layer-composition.md) — `dispatchRuntime` and `FullLive` that are disposed here
- [WebSocket connection lifecycle](./ws-connection-lifecycle.md) — `conn.shutdown` / `closeRequested` Deferred detail
