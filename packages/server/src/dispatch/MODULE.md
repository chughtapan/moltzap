...
### [`DispatchAdmissionService`](./admission.service.ts#L95)
...
### [`EnqueueDispatchRequestArgs`](./admission.service.ts#L66)
...
### [`leaseRegistryLive`](./layer.ts#L30)
