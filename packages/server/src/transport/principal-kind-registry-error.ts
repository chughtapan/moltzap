/**
 * @file The boot-time fail-closed wiring error for the WS engine.
 */
 ...
 * built member count drifting from the catalog. Either is a wiring bug that must
 * fail loudly at boot, never a silent permissive default
