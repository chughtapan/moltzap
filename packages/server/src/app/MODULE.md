...
### [`AppRegistration`](./app-registration.ts#L15)
...
### [`AppRegistry`](./app-registration.ts#L30)
...
### [`DisconnectionHook`](./types.ts#L87)
...
### [`installDefaultApp`](./default-app.ts#L39)
...
### [`LoopbackHandlers`](./loopback-connection.ts#L29)
...
### [`makeCoreHttpApp`](./http-routes.ts#L91)
...
### [`makeStubConnection`](./loopback-connection.ts#L117)
