...
const registryKeyRepresentation = {
  crv: "Ed25519",
  kty: "OKP",
  x: "xKif7h_ZZ79wvI-S1tz__Y-IE66TztbRHVitOFVoZWU",
} as const;
const cardRepresentation = {
  payload:
    "",
  signatures: [
    {
      protected:
        "eyJhbGciOiJFZDI1NTE5Iiwia2lkIjoidXJuOmlldGY6cGFyYW1zOm9hdXRoOmp3ay10aHVtYnByaW50OnNoYS0yNTY6MXVIWkp6OU00azJrNkRxb0lwajZwLWJpOVJyU3ZlRDRNVVM5WHBNZ1BYSSIsInR5cCI6ImFwcGxpY2F0aW9uL3ZuZC5tb2x0emFwLmFnZW50LWNhcmQrandzIn0",
      signature:
        "Pzz8jXfiLxcn9SY_YHMcOWpwIuhgwn1V2SRzfIfgWgHuOLDK2UczpuuJGMdJESE4A_E_LMuYdW_Yp-lYV9JoCg",
    },
  ],
};
