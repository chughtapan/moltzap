 ...
 */
// safer-arch-ignore shared-kernel-cohesion: the closed InfraError taxonomy lives in one kernel by design; each contract module consumes its own error subset, so pairwise consumer overlap is structurally low.
