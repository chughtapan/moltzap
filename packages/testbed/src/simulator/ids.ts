 ...
 * construction order.
 */
// safer-arch-ignore shared-kernel-cohesion: branded ids and closed vocabularies are one shared kernel by design; each module consumes its own id subset, so pairwise consumer overlap is structurally low.
