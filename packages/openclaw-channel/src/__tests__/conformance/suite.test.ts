...
const TEST_AGENT_KEY = "openclaw-test-agent-key";
const TEST_AGENT_ID = "00000000-0000-4000-8000-00000000a01c";
...
describe("@moltzap/openclaw-channel client-side conformance", () => {
  it(
    "client-side properties pass against the openclaw-channel real client",
    () =>
      Effect.runPromise(
        Effect.gen(function* () {
