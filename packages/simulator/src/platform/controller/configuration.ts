...
import type { DistributedContainerImage } from "../../runtime/distributed.js";
import type { KubernetesPodPlacement } from "../kubernetes/profile.js";
...
/** Fully validated values shared by the entry point and infrastructure helper. */
...
function supportImage(
  ...
  return value as DistributedContainerImage;
}
