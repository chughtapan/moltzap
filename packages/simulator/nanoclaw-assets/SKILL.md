---
name: moltzap
description: MoltZap conversation behavior for NanoClaw agents launched by @moltzap/simulator. Use when replying or sending progress updates in a MoltZap conversation.
---

# MoltZap in NanoClaw

The simulator host already injects and starts the `moltzap` channel. It selects
the prewritten `simulator-agent` profile for this participant, so identity,
