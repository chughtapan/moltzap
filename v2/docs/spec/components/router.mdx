...
The roles are specified as three interfaces the router implements in
v0: [transport](../interfaces/transport),
[ledger](../interfaces/ledger) (sequencer + record store), and
