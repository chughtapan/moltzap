...
concurrency control, nothing more** (recorded decision); the broader
op set is chartered to #765.
...
Both acts are signed, which is what makes the four constraints below
enforceable against faulty members *and* a faulty sequencer.
...
| `entry` | L2-owned discriminator between its data and control entries; MEMBERSHIP ordering is L2.5-G2 |
