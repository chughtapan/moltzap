...
import { parseCanonicalJson } from "../identity-json.js";
...
const requireAdmissionCredential = (
...
const authenticatePublicKey = (
  candidate: typeof registrationPublicKeyRepresentation.Type,
) =>
  Schema.decodeUnknown(Ed25519PublicKey)(candidate).pipe(
 ...
 */
export const verifyBootstrapRegistration = (
  input: BootstrapRegistrationInput,
): Effect.Effect<
